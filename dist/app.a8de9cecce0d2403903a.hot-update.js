...
})(["position:absolute;justify-content:center;top:30%;position:relative;display:flex;@media ", "{position:absolute;justify-content:center;top:30%;}"], _ref => {
  let {
    theme
  } = _ref;
...
})(["font-weight:500;display:flex;justify-content:space-around;gap:20px;width:400px;@media ", "{font-weight:500;display:flex;justify-content:space-around;gap:20px;}"], _ref2 => {
  let {
    theme
  } = _ref2;
  return theme.media.medium;
...
})(["color:", ";font-family:\"Inter\";font-style:normal;font-weight:400;font-size:128px;line-height:155px;@media ", "{font-size:60px;font-weight:700;letter-spacing:-0.02em;text-align:center;}"], _ref3 => {
  let {
    theme
  } = _ref3;
...
})(["color:", ";font-family:\"Inter\";font-style:normal;font-weight:400;font-size:128px;line-height:155px;@media ", "{font-size:60px;font-weight:700;letter-spacing:-0.02em;text-align:center;}"], _ref5 => {
  let {
    theme
  } = _ref5;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("45988796f005cbb434cb")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=app.a8de9cecce0d2403903a.hot-update.js.map