...
})(["position:absolute;top:400px;left:5%;z-index:10;@media ", "{display:flex;justify-content:space-between;width:120px;}"], _ref => {
  let {
    theme
  } = _ref;
...
})(["height:50px;width:50px;border-radius:50%;cursor:pointer;transition:background 0.3s;border:1px solid black;background-color:transparent;&:hover{background:gray;}"]);
const Controller = _ref2 => {
  let {
    onPrev,
    onNext
  } = _ref2;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("89d64f5a4ab13a7ba7c6")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=app.1cbd943d755fcd34f19c.hot-update.js.map